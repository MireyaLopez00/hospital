...
<img src="imagenes/consultar.png" hspace="100" vspace="5"> </a>
  	...
  	<h2>TABLA DE NOTA POST-OPERATORIA</h2>
				...
				<form action="nota_post_pro.php"  method="POST">
					<center>
						<div class="input-group">
			   			<p>Id nota post-operatoria: </p>
			   			<input type="text" name="id_post"placeholder="                                  800-900">
			   			</div>
			   			<div class="input-group">
			   			...
			   			<div class="input-group">
			   			<p>Diagnóstico pre-operatorio: </p>
			   			<textarea type="text" name="diagnostico_preope"  cols="50" rows="10"></textarea>
			   			</div>
			   			<div class="input-group">
			   			<p>Diagnóstico post-operatorio: </p>
			   			<textarea type="text" name="diagnostico_post" cols="50" rows="10"></textarea>
			   			</div>
			   			<div class="input-group">
			   			<p>Operación realizada: </p>
			   			<input type="text" name="operacion_reali">
			   			</div>
			   			<br>
			   			<center>
